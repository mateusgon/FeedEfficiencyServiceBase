 ...
 * @author Heitor
 */
public class TOBebedouro extends TOBase {
    ...
    public TOBebedouro(Integer codigo, Integer animal, float id, float peso, float duracao, float consumido, Date data, String hora) {
        this.codigo = codigo;
        this.animal = animal;
        this.id = id;
        this.peso = peso;
    ...
    public TOBebedouro(ResultSet rs) throws Exception {
    ...
    public JSONObject getJson() {
        ...
        try {
            ...
            Logger.getLogger(TOBebedouro.class.getName()).log(Level.SEVERE, null, ex);
        }
